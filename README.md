...
For the full mathematical treatment — Egyptian compression length, conjecture statements, and the overflow threshold argument — see [egyptian_compression_length.md](egyptian_compression_length.md).
