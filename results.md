...
## Experiment 1: Goldbach / ESC Channel Split

**Script**: `esc_goldbach_split_ml.py`
...
| B — Additive + ESC | 58 | 0.0443 | 0.0660 | −0.895 |
| **Improvement (B − A)** | +10 ESC features | **−0.0076** | **−0.0102** | **+0.629** |
...
|------|---------|--------------------|------|
| 1 | `esc_first_m_mean` | 0.01107 | 0.00046 |
| 2 | `hl_estimate` | 0.00789 | 0.00023 |
| 3 | `log_hl_estimate` | 0.00626 | 0.00013 |
| 4 | `esc_density_std` | 0.00234 | 0.00011 |
| 5 | `ramanujan_c_30_norm` | 0.00106 | 0.00020 |
| 6 | `esc_first_m_max` | 0.00094 | 0.00011 |
| 7 | `esc_pair_hard_any_rate` | 0.00087 | 0.000084 |
| 8 | `esc_density_mean` | 0.00081 | 0.000049 |
| 9 | `ramanujan_c_5_norm` | 0.00038 | 0.000019 |
| 10 | `esc_first_m_min` | 0.00035 | 0.000043 |

### Key Observations

**`esc_first_m_mean` is the single strongest predictor**, ranking above the Hardy–Littlewood estimate itself. This feature aggregates, for each prime p in the Goldbach fiber of N, the smallest m for which the gate k/p = 1/(p·m) + ... succeeds. Its dominance suggests that the "difficulty" of the ESC inversion over the prime fiber tracks the deviation of Goldbach counts from the Hardy–Littlewood prediction.

**ESC density features (`esc_density_std`, `esc_density_mean`) outperform most Ramanujan terms.** The density measures how many m-values in [1, m_limit] solve the gate — a proxy for how "solvable" the multiplicative structure around N is. Variance of density across the fiber (`esc_density_std`) ranks 4th overall.

**`esc_pair_hard_any_rate`** measures the fraction of prime pairs in the Goldbach fiber where at least one prime falls in a Mordell hard residue class mod 840. Its presence in the top 10 confirms that the hard-residue obstruction structure has measurable impact on Goldbach counts beyond what smooth modular arithmetic captures.
